    ...
    if (command == "clear") {
      ...
      if (command.split(" ").length == 2) {
        if (command.split(" ")[1].trim() == "fichier.txt") {
          ...
          $(".terminal-output").append(
            '<div class="result"><div style="width: 100%;"><span>fichier doesn\'t exist</span></div></div><br>'
          );
          reset();
        }
      } //end else if de commande
      else {
        $(".terminal-output").append(
          '<div class="command" role="presentation" aria-hidden="true"><div style="width: 100%;"><span class="user">root@' +
            username +
        ...
        $(".terminal-output").append(
          '<div class="result"><div style="width: 100%;"><span>You need a seconde parametre</span></div></div><br>'
        );
        reset();
      }
